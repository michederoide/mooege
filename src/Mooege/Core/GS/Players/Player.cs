...
namespace Mooege.Core.GS.Players
{
    public class Player : Actor, IMessageConsumer, IUpdateable
    {
            ...
            : base(world, GetClassSNOId(bnetToon.Gender, bnetToon.Class))
        {
            ...
            //Resource
            this.Attributes[GameAttribute.Resource_Cur, this.ResourceID] = 2000f;
            this.Attributes[GameAttribute.Resource_Max, this.ResourceID] = 2000f;
            this.Attributes[GameAttribute.Resource_Max_Total, this.ResourceID] = 2000f;
            this.Attributes[GameAttribute.Resource_Effective_Max, this.ResourceID] = 2000f;
